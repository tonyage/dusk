...
set -g status-right "#[fg=${bg_statusline},bg=${bg_statusline},nobold,nounderscore,noitalics]#[fg=${blue},bg=${bg_statusline}] #{prefix_highlight} #[fg=${window.bg},bg=${bg_statusline},nobold,nounderscore,noitalics]#[fg=${blue},bg=${window.bg}] %Y-%m-%d  %I:%M %p #[fg=${blue},bg=${window.bg},nobold,nounderscore,noitalics]#[fg=${black},bg=${blue},bold] #h "

setw -g window-status-activity-style "underscore,fg=${white},bg=${bg_statusline}"
setw -g window-status-separator ""
setw -g window-status-style "${none},fg=${white},bg=${bg_statusline}"
...
setw -g window-status-current-format "#[fg=${bg_statusline},bg=${window.bg},nobold,nounderscore,noitalics]#[fg=${blue},bg=${window.bg},bold] #I  #W #F #[fg=${window.bg},bg=${bg_statusline},nobold,nounderscore,noitalics]"
