...
function M.setup()
  ...
  theme.highlights = {
    ...
    TabLine = { bg = c.bg_statusline, fg = c.white }, -- tab pages line, not active tab page label
    ...
    BufferVisible = { bg = c.bg_statusline, fg = c.white },
    ...
    BufferInactive = { bg = c.bg_statusline, fg = c.window.muted_fg },
    ...
    BufferInactiveIndex = { bg = c.bg_statusline, fg = c.window.muted_fg },
    ...
    BufferOffset = { bg = c.bg_statusline, fg = c.window.muted_fg },
    BufferTabpageFill = { bg = c.bg_statusline, fg = c.window.muted_fg },
